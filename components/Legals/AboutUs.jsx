  ...
  <>
    <section className="bg-white py-12 sm:py-16 lg:py-20">
      <div className="site-container mx-auto grid items-center gap-10 px-5 sm:px-8 lg:grid-cols-[minmax(0,1fr)_430px] lg:gap-16 lg:px-12">
        <div>
          <p className="flex items-center gap-2 text-[14px] font-[500] uppercase tracking-[0.2em] text-accent-strong"><FiCompass aria-hidden="true" />About Sea Sky Solutions LLC</p>
          ...
          <div className="mt-7 grid gap-4 sm:grid-cols-3">
            {values.map(({ title, text, icon: Icon }) => <article key={title} className="rounded-[18px] border border-[var(--brand-blue)]/12 bg-section-muted p-5"><span className="flex size-10 items-center justify-center rounded-full bg-[var(--brand-green)]/15 text-[20px] text-[var(--brand-blue)]"><Icon aria-hidden="true" /></span><h3 className="mt-4 text-[17px] font-[500] text-[var(--brand-blue)]">{title}</h3><p className="mt-2 text-[14px] leading-6 text-[var(--brand-blue)]/65">{text}</p></article>)}
          </div>
        </div>
        <div className="relative mx-auto w-full max-w-[390px]">
          ...
          <div className="absolute bottom-8 left-0 z-20 rounded-2xl bg-white px-5 py-4 shadow-card"><p className="flex items-center gap-2 text-[15px] font-[500] text-[var(--brand-blue)]"><FiCheckCircle className="text-accent-strong" aria-hidden="true" />Your journey, considered.</p></div>
        </div>
      </div>
    </section>
    ...
    <section className="bg-section-muted py-12 sm:py-16 lg:py-20">
      <div className="site-container mx-auto px-5 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-2xl text-center"><p className="text-[14px] font-[500] uppercase tracking-[0.2em] text-accent-strong">How we help</p><h2 className="mt-2 text-[30px] font-[500] leading-[1.1] text-[var(--brand-blue)] sm:text-[42px]">One place to start every journey.</h2><p className="mt-4 text-[16px] leading-7 text-[var(--brand-blue)]/65">Whatever your travel style, we help bring the moving parts together with clear options and personal attention.</p></div>
    ...
    <section className="bg-[var(--brand-blue)] py-12 sm:py-14">
      <div className="site-container mx-auto flex flex-col gap-6 px-5 text-center sm:px-8 lg:flex-row lg:items-center lg:justify-between lg:px-12 lg:text-left"><div><p className="text-[14px] font-[500] uppercase tracking-[0.2em] text-accent-strong">Start exploring</p><h2 className="mt-2 text-[29px] font-[500] leading-[1.1] text-white sm:text-[38px]">Ready to plan your next escape?</h2></div><Link href="/#find-your-tour" className="inline-flex min-h-[54px] shrink-0 items-center justify-center gap-3 rounded-full bg-[var(--brand-green)] px-6 text-[16px] font-[700] text-accent-contrast transition hover:bg-white hover:text-[var(--brand-blue)]">Find your tour <FiArrowRight aria-hidden="true" /></Link></div>
    </section>
  </>
);
