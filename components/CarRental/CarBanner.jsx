...
const CarBanner = () => {
  return (
    <section className="relative isolate min-h-[520px] overflow-hidden bg-[#eef8ff]">
      <div
        className="absolute inset-0 -z-20 bg-cover bg-[center_top] lg:bg-center"
        style={{
          backgroundImage: "url(/images/car-banner.webp)",
        }}
        aria-hidden="true"
      />
      <div
        className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(255,255,255,0.96)_0%,rgba(255,255,255,0.9)_30%,rgba(255,255,255,0.58)_55%,rgba(255,255,255,0.08)_82%)]"
        aria-hidden="true"
      />
      <div
