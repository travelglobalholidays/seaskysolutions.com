...
export const metadata = createPageMetadata({
  title: "Travel FAQs",
  description:
    "Find answers to common questions about planning, booking, changes and cancellations with Sea Sky Solutions.",
  path: "/faqs",
  keywords: ["travel booking FAQs", "travel questions"],
});

const faqs = [
  ["How do I start planning a trip?", "Share your preferred destination, travel dates, number of travellers and budget. Sea Sky Solutions can help narrow down options that suit your plans."],
  ...
  ["How can I contact Sea Sky Solutions about a booking?", `Email ${siteContact.email.address} with your booking reference, traveller name and a concise description of your request. We will review the available options and respond with the next steps.`],
...
const FaqPage = () => (
  <LegalPageLayout title="Frequently Asked Questions" eyebrow="Helpful answers">
    <p>Find quick answers to common questions about planning, booking and managing travel with Sea Sky Solutions.</p>
