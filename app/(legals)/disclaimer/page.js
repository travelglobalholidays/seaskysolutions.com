...
export const metadata = createPageMetadata({
  title: "Disclaimer",
  description: "Read the Sea Sky Solutions LLC website and travel information disclaimer.",
  path: "/disclaimer",
...
const DisclaimerPage = () => (
  <LegalPageLayout title="Disclaimer" eyebrow="Important travel information">
    ...
    <p>The information on this website is provided for general travel-planning purposes. While Sea Sky Solutions LLC aims to keep content helpful and current, travel information can change quickly and may not be complete for every traveller or destination.</p>
    ...
    <p>Travel products and links may be provided by independent suppliers. Sea Sky Solutions LLC does not control their operations, content, availability or policies. Supplier descriptions, images, ratings and prices may change without notice.</p>
    ...
    <p>To the extent permitted by applicable law, Sea Sky Solutions LLC is not responsible for losses caused by inaccurate third-party information, supplier actions, travel disruptions or circumstances outside our reasonable control.</p>
  </LegalPageLayout>
);
